...
router.get(
  ...
  isAuthenticated,
  isManager,
  managerController.getDashboardHtml,
);
router.get(
  "/users.html",
  isAuthenticated,
  isManager,
  managerController.getUsersHtml,
);
router.get(
  "/services.html",
  isAuthenticated,
  isManager,
  managerController.getServicesHtml,
);
router.get(
  "/payments.html",
  isAuthenticated,
  isManager,
  managerController.getPaymentsHtml,
);
router.get(
  "/support.html",
  isAuthenticated,
  isManager,
  managerController.getSupportHtml,
);
...
router.get(
  ...
  isAuthenticated,
  isManager,
  managerController.getApiDashboardReport,
);
...
router.post(
  ...
  isAuthenticated,
  isManager,
  managerController.suspendUser,
);
router.post(
  "/users/restore/:id",
  isAuthenticated,
  isManager,
  managerController.restoreUser,
);
router.post(
...
router.post(
  ...
  isAuthenticated,
  isManager,
  managerController.cancelBooking,
);
router.post(
  "/restore-booking/:id",
  isAuthenticated,
  isManager,
  managerController.restoreBooking,
);
...
router.post(
  ...
  isAuthenticated,
  isManager,
  managerController.cancelOrder,
);
router.post(
  "/restore-order/:orderId",
  isAuthenticated,
  isManager,
  managerController.restoreOrder,
);
...
router.post(
  ...
  isAuthenticated,
  isManager,
  managerController.verifyProvider,
);
